...
density_diffusion_demo: ./examples/density_diffusion_demo.cpp $(BioFVM_OBJECTS) $(pugixml_OBJECTS)
	$(COMPILE_COMMAND) -o ./examples/density_diffusion_demo ./examples/density_diffusion_demo.cpp $(BioFVM_OBJECTS) $(pugixml_OBJECTS)
complete_diffusion_demo: ./examples/complete_diffusion_demo.cpp $(BioFVM_OBJECTS) $(pugixml_OBJECTS)
	$(COMPILE_COMMAND) -o ./examples/complete_diffusion_demo ./examples/complete_diffusion_demo.cpp $(BioFVM_OBJECTS) $(pugixml_OBJECTS)
